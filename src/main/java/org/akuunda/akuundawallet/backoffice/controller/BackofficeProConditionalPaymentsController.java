...
@RestController
@RequestMapping(path = "/api/v1/pro/conditional-payments", produces = MediaType.APPLICATION_JSON_VALUE)
@Tag(name = "Backoffice - Pro Conditional Payments")
@RequiredArgsConstructor
public class BackofficeProConditionalPaymentsController {

    private final BackofficeAdminService backofficeAdminService;

    @GetMapping
    @Operation(summary = "Liste des paiements conditionnels (pro)")
    ...
    @Operation(summary = "Détail paiement conditionnel")

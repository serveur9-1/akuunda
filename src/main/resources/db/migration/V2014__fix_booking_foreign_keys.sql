-- ====================================================================
-- Migration: Fix booking tables (without FK to users for now)
-- ====================================================================
...
-- 2. Recreate hotels (owner_id as BIGINT without FK constraint)
CREATE TABLE hotels (
...
-- 4. Recreate transport_providers
...
CREATE INDEX idx_transport_provider_owner ON transport_providers(owner_id);
CREATE INDEX idx_transport_provider_city ON transport_providers(city);
CREATE INDEX idx_transport_provider_is_available ON transport_providers(is_available);
...
CREATE INDEX idx_vehicle_provider ON vehicles(provider_id);
...
CREATE INDEX idx_booking_provider_user ON bookings(provider_user_id);
CREATE INDEX idx_booking_status ON bookings(status);
CREATE INDEX idx_booking_type ON bookings(type);
CREATE INDEX idx_booking_conditional_payment ON bookings(conditional_payment_id);
